...
//    private static final double WHEEL_DIAMETER = 6; // Not needed right now
    ...
    public void setDriveStick(XboxController s)// Joystick j) // setDriveStick is presumably called once from OI after joystick initialization
    {
        ...
        m_controlManager.registerExpressionOutput("Forward", "(LTRIG-RTRIG)^3");
        m_controlManager.registerExpressionOutput("Rotation", "LJOYX/3");
        m_controlManager.registerExpressionOutput("Forward (Reversed)", "-1*LTRIG-RTRIG");
        m_controlManager.registerExpressionOutput("Rotation (Reversed)", "-1*LJOYX^3/3");
    }
